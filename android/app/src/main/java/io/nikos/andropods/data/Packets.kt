...
class AirPodsNotifications {
    companion object {
        const val AIRPODS_CONNECTED = "io.nikos.andropods.AIRPODS_CONNECTED"
        const val AIRPODS_L2CAP_CONNECTED = "io.nikos.andropods.AIRPODS_CONNECTED"
        const val AIRPODS_DATA = "io.nikos.andropods.AIRPODS_DATA"
        const val EAR_DETECTION_DATA = "io.nikos.andropods.EAR_DETECTION_DATA"
        const val ANC_DATA = "io.nikos.andropods.ANC_DATA"
        const val BATTERY_DATA = "io.nikos.andropods.BATTERY_DATA"
        const val CA_DATA = "io.nikos.andropods.CA_DATA"
        const val AIRPODS_DISCONNECTED = "io.nikos.andropods.AIRPODS_DISCONNECTED"
        const val AIRPODS_CONNECTION_DETECTED = "io.nikos.andropods.AIRPODS_CONNECTION_DETECTED"
        const val DISCONNECT_RECEIVERS = "io.nikos.andropods.DISCONNECT_RECEIVERS"
        const val EQ_DATA = "io.nikos.andropods.EQ_DATA"
        const val AIRPODS_INFORMATION_UPDATED = "io.nikos.andropods.AIRPODS_INFORMATION_UPDATED"
    }
