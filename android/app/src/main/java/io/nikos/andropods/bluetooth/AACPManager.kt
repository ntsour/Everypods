...
import io.nikos.andropods.bluetooth.connection.DeferredHandshakeAckSource
...
class AACPManager {
     ...
     * transition to [io.nikos.andropods.bluetooth.connection.ConnectionState.Connected].
     */
