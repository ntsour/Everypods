...
package io.nikos.andropods.presentation.viewmodel
...
import io.nikos.andropods.bluetooth.AACPManager.Companion.ControlCommandIdentifiers
...
//                }
    ...
    fun setPressAction(side: String, pressType: io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType, action: StemAction) {
        val sideLower = side.lowercase()
        val prefKey = when (pressType) {
            io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.SINGLE_PRESS ->
                if (sideLower == "left") "left_single_press_action" else "right_single_press_action"
            io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.DOUBLE_PRESS ->
                if (sideLower == "left") "left_double_press_action" else "right_double_press_action"
            io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.TRIPLE_PRESS ->
                if (sideLower == "left") "left_triple_press_action" else "right_triple_press_action"
            io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.LONG_PRESS ->
        ...
        if (pressType == io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.LONG_PRESS) {
            _uiState.update {
    ...
    fun setGymPressAction(side: String, pressType: io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType, action: StemAction) {
        val sideLower = side.lowercase()
        val pressShort = when (pressType) {
            io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.DOUBLE_PRESS -> "double"
            io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.TRIPLE_PRESS -> "triple"
            io.nikos.andropods.bluetooth.AACPManager.Companion.StemPressType.LONG_PRESS -> "long"
            else -> return
        }
