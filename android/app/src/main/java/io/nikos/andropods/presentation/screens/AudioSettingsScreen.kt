    ...
    StyledScaffold(title = "Audio Settings") { topPadding, hazeState, bottomPadding ->
        Column(
            ...
            AudioSettings(
                ...
                loudSoundReductionCapability = state.capabilities.contains(io.nikos.andropods.data.Capability.LOUD_SOUND_REDUCTION),
                adaptiveAudioCapability = state.capabilities.contains(io.nikos.andropods.data.Capability.ADAPTIVE_VOLUME),
                ...
                onLoudSoundReductionCheckedChange = { if (it) viewModel.setATTCharacteristicValue(io.nikos.andropods.bluetooth.ATTHandles.LOUD_SOUND_REDUCTION, byteArrayOf(1)) else viewModel.setATTCharacteristicValue(io.nikos.andropods.bluetooth.ATTHandles.LOUD_SOUND_REDUCTION, byteArrayOf(0)) },
