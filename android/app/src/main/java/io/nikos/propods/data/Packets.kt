...
class AirPodsNotifications {
    companion object {
        const val AIRPODS_CONNECTED = "io.nikos.propods.AIRPODS_CONNECTED"
        const val AIRPODS_L2CAP_CONNECTED = "io.nikos.propods.AIRPODS_CONNECTED"
        const val AIRPODS_DATA = "io.nikos.propods.AIRPODS_DATA"
        const val EAR_DETECTION_DATA = "io.nikos.propods.EAR_DETECTION_DATA"
        const val ANC_DATA = "io.nikos.propods.ANC_DATA"
        const val BATTERY_DATA = "io.nikos.propods.BATTERY_DATA"
        const val CA_DATA = "io.nikos.propods.CA_DATA"
        const val AIRPODS_DISCONNECTED = "io.nikos.propods.AIRPODS_DISCONNECTED"
        const val AIRPODS_CONNECTION_DETECTED = "io.nikos.propods.AIRPODS_CONNECTION_DETECTED"
        const val DISCONNECT_RECEIVERS = "io.nikos.propods.DISCONNECT_RECEIVERS"
        const val EQ_DATA = "io.nikos.propods.EQ_DATA"
        const val AIRPODS_INFORMATION_UPDATED = "io.nikos.propods.AIRPODS_INFORMATION_UPDATED"
    }
