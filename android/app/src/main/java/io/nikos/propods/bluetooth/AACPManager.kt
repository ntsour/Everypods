...
package io.nikos.propods.bluetooth

import android.util.Log
import io.nikos.propods.bluetooth.connection.DeferredHandshakeAckSource
...
class AACPManager {
     ...
     * transition to [io.nikos.propods.bluetooth.connection.ConnectionState.Connected].
     */
