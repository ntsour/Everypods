 ...
 * must enable EveryPods in that list.
 */
class NotificationAnnouncementService : NotificationListenerService() {
    ...
    companion object {
        ...
        @Volatile var isListenerConnected: Boolean = false
            private set
        ...
        private val IGNORED_PACKAGES = setOf(
            ...
            "io.automated.ventures.everypods.announce",
        )
    ...
    override fun onListenerDisconnected() {
        ...
        requestRebind(ComponentName(applicationContext, NotificationAnnouncementService::class.java))
    }
