...
class AirPodsNotifications {
    companion object {
        const val AIRPODS_CONNECTED = "io.automated.ventures.everypods.AIRPODS_CONNECTED"
        const val AIRPODS_L2CAP_CONNECTED = "io.automated.ventures.everypods.AIRPODS_CONNECTED"
        const val AIRPODS_DATA = "io.automated.ventures.everypods.AIRPODS_DATA"
        const val EAR_DETECTION_DATA = "io.automated.ventures.everypods.EAR_DETECTION_DATA"
        const val ANC_DATA = "io.automated.ventures.everypods.ANC_DATA"
        const val BATTERY_DATA = "io.automated.ventures.everypods.BATTERY_DATA"
        const val CA_DATA = "io.automated.ventures.everypods.CA_DATA"
        const val AIRPODS_DISCONNECTED = "io.automated.ventures.everypods.AIRPODS_DISCONNECTED"
        const val AIRPODS_CONNECTION_DETECTED = "io.automated.ventures.everypods.AIRPODS_CONNECTION_DETECTED"
        const val DISCONNECT_RECEIVERS = "io.automated.ventures.everypods.DISCONNECT_RECEIVERS"
        const val EQ_DATA = "io.automated.ventures.everypods.EQ_DATA"
        const val CUSTOM_EQ_DATA = "io.automated.ventures.everypods.CUSTOM_EQ_DATA"
        const val AIRPODS_INFORMATION_UPDATED = "io.automated.ventures.everypods.AIRPODS_INFORMATION_UPDATED"
    }
