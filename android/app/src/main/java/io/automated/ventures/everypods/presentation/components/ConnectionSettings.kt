...
import io.automated.ventures.everypods.presentation.viewmodel.PeerUiInfo
...
fun ConnectionSettings(
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.cross_device_settings_hint),
            style = TextStyle(
                fontSize = 12.sp,
                fontFamily = FontFamily(Font(R.font.sf_pro)),
                color = if (isDarkTheme) Color.White.copy(alpha = 0.62f)
