    ...
    StyledScaffold(title = "Microphone Settings") { topPadding, hazeState, bottomPadding ->
        Column(
            ...
            MicrophoneSettings(
                ...
                micModeValue = state.controlStates[io.automated.ventures.everypods.bluetooth.AACPManager.Companion.ControlCommandIdentifiers.MIC_MODE]?.getOrNull(0) ?: 0x00,
                onMicModeValueChanged = { viewModel.setControlCommandByte(io.automated.ventures.everypods.bluetooth.AACPManager.Companion.ControlCommandIdentifiers.MIC_MODE, it) }
            )
