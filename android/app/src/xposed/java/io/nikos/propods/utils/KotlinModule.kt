...
private const val TAG = "ProPodsHook"
        ...
        if (param.packageName == "com.google.android.bluetooth" || param.packageName == "com.android.bluetooth") {
            ...
            try {
                if (param.isFirstPackage) {
                    ...
                    val remotePrefValue = getRemotePreferences("io.nikos.propods").getBoolean("vendor_id_hook", false)
        ...
        try {
            ...
            hook(updateIconMethod).intercept { chain ->
                try {
                    ...
                    if (!uri.toString().startsWith("android.resource://io.nikos.propods")) {
                        return@intercept chain.proceed()
                    }
